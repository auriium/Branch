...
public class PermissionAnnotationParser<T> {
    ...
    me.aurium.beetle.branch.permission.Permission<T> parse(Annotation annotate) throws IllegalAccessException, InstantiationException {
        ...
        return (me.aurium.beetle.branch.permission.Permission<T>) perm;
    }
