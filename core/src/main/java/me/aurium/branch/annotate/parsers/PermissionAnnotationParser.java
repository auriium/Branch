...
import me.aurium.branch.annotate.marker.permission.Permission;
import me.aurium.branch.fallback.permissions.StringPermission;
...
public class PermissionAnnotationParser<T> {
    ...
    me.aurium.branch.fallback.permissions.Permission<T> parse(Annotation annotate) throws IllegalAccessException, InstantiationException {
        ...
        return (me.aurium.branch.fallback.permissions.Permission<T>) perm;
    }
